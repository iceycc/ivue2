  ...
  var Watcher = /*#__PURE__*/function () {
    ...
    _createClass(Watcher, [{
      ...
      value: function get() {
        ...
        var value = this.getter.call(this.vm); // 2、对属性进行取值 vm._update(vm._render()) // 生成真实dom了，过程中会对模版中对属性进行get操作，触发Observer get同时添加到dep
      ...
      value: function run() {
        ...
        if (this.user) {
          // 用户的watcher，执行用户的callback，并将新值就值传入
